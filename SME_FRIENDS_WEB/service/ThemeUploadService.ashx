<%@ WebHandler Language="C#" Class="ThemeUploadService" %>
...
public class ThemeUploadService : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        foreach (string item in context.Request.Files.AllKeys)
        {
            ...
            {//上传主题图片
                filePath = HttpContext.Current.Server.MapPath("/file/temp/Theme/ThemeUrl/");
            }
            else
            {
