<%@ WebHandler Language="C#" Class="BackgroundLogoUploadService" %>
...
public class BackgroundLogoUploadService : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        foreach (string item in context.Request.Files.AllKeys)
        {
            ...
            {//上传主题背景图片
                filePath = HttpContext.Current.Server.MapPath("/file/temp/Theme/BackgroundLogoUrl/");
            }
            else
            {
