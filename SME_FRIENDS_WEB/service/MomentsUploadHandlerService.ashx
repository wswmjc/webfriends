<%@ WebHandler Language="C#" Class="MomentsUploadHandlerService" %>
...
public class MomentsUploadHandlerService : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string filePath = HttpContext.Current.Server.MapPath("/file/temp/Moments/" + type + "/");
        if (type == "LongInfoImage")
        {
            filePath = HttpContext.Current.Server.MapPath("/file/Moments/" + type + "/");
        }
        ...
        context.Response.Write(Config.Serializer.Serialize(new
        {
            ...
            {
                FileName = fileName,
                FilePath = "/file/Moments/" + type + "/" + newFileName,
                FileExt = fileExt,
                FileType = fileType,
                TempPath = "/file/temp/Moments/" + type + "/" + newFileName
            }
        }));
        context.Response.End();
    }
