...
//                }
        ...
        close: function ($img) {
            ...
            $img.css({
                ...
                $.SimpleAjaxPostWithError("service/MomentsService.asmx/DeleteTempFile",
                                          true,
                                          "{tempPath:'" + path + "'}",
                                          function (x, e) {
                                              if (x.responseText === undefined) {
                                                  ...
                                                  $.Alert($.Deserialize(x.responseText, true).Message);
                                              }
                                          }).done(function (json) {
                                              var result = json.d;
                                              if (result == true) {
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="upfile" accept=".jpeg,.png,.jpg,.bmp"/>' +
            '</form>' +
