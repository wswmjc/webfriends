...
intellisense.annotate(jQuery, {
	...
	"Deserialize": function () {
		...
		///<param name="jsonString" type="String">json字符串</param>
		///<returns type="Object"/>
		///</signature>
		...
		///<summary>反序列化</summary>
		///<param name="jsonString" type="String">json字符串</param>
		///<param name="isStrict" type="Boolean">是否严格匹配</param>
		///<returns type="Object"/>
		///</signature>
	},
	"Serialize": function () {
		///<signature>
		///<summary>序列化</summary>
		///<param name="obj" type="Object">序列化对象</param>
		///<returns type="String"/>
		///</signature>
	...
	"SimpleAjaxPost":function(){
		///<signature>
		///<summary>简单的Ajax调用（POST）（有参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="async" type="Boolean">是否异步操作</param>
		///<param name="data_str" type="String">传输数据</param>
		///<param name="success(data, textStatus, jqXHR)" type="Function">成功回调函数</param>
		///<returns type="jqXHR"/>
		///</signature>

		///<signature>
		///<summary>简单的Ajax调用（POST）（无参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="async" type="Boolean">是否异步操作</param>
		///<param name="success(data, textStatus, jqXHR)" type="Function">成功回调函数</param>
		///<returns type="jqXHR"/>
	...
	"SimpleAjaxPostWithError":function(){
	    ///<signature>
	    ///<summary>简单的Ajax调用（POST）（有参）</summary>
	    ///<param name="url_str" type="String">URL</param>
	    ///<param name="async" type="Boolean">是否异步操作</param>
	    ///<param name="data_str" type="String">传输数据</param>
	    ///<param name="success(data, textStatus, jqXHR)" type="Function">成功回调函数</param>
	    ///<param name="error(XMLHttpRequest,message)" type="Function">失败回调函数</param>
	    ///<returns type="jqXHR"/>
	    ///</signature>
	...
	"SimpleJsonpAjax":function(){
		///<signature>
		///<summary>基于Jsonp的简单Ajax跨域调用（GET）（有参）</summary>
		///<param name="url_str" type="Array">URL</param>
		///<param name="data_str" type="Object">传输数据</param>
		///<returns type="jqXHR"/>
		///</signature>
		...
		///<signature>
		///<summary>基于Jsonp的简单Ajax跨域调用（GET）（无参）</summary>
		///<param name="url_str" type="Array">URL</param>
		///<returns type="jqXHR"/>
		///</signature>
	...
	"SimpleJsonpAjaxWithError": function () {
	    ///<signature>
	    ///<summary>基于Jsonp的简单Ajax跨域调用（GET）（有参）</summary>
	    ///<param name="url_str" type="Array">URL</param>
	    ///<param name="data_str" type="Object">传输数据</param>
	...
	"SimpleAjaxCors": function () {
		///<signature>
		///<summary>基于Cors的简单Ajax跨域调用（有参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="trans_type" type="String">POST/GET</param>
		///<param name="data_str" type="String">传输数据</param>
		///<returns type="jqXHR"/>
		///</signature>
		...
		///<signature>
		///<summary>基于Cors的简单Ajax跨域调用（无参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="trans_type" type="String">POST/GET</param>
		///<returns type="jqXHR"/>
		///</signature>
	...
	"SimpleAjaxCorsWithError": function () {
	    ///<signature>
	    ///<summary>基于Cors的简单Ajax跨域调用（有参）</summary>
	    ///<param name="url_str" type="String">URL</param>
	    ///<param name="trans_type" type="String">POST/GET</param>
	...
	"AjaxCors": function () {
		///<signature>
		///<summary>基于Cors的Ajax跨域调用（有参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="trans_type" type="String">POST/GET</param>
		///<param name="data_str" type="String">传输数据</param>
		///<param name="success(data, textStatus, jqXHR)" type="Function">成功回调函数</param>
		...
		///<signature>
		///<summary>基于Cors的Ajax跨域调用（无参）</summary>
		///<param name="url_str" type="String">URL</param>
		///<param name="trans_type" type="String">POST/GET</param>
		///<param name="success(data, textStatus, jqXHR)" type="Function">成功回调函数</param>
		///<returns type="jqXHR"/>
	...
	"Post": function () {
		...
		///<param name="url_str" type="String">URL</param>
		///<param name="data" type="Object">传输数据</param>
		///<returns type="jqXHR"/>
		///</signature>
	},
	"Get": function () {
	...
	"ClearCookie":function(){
		...
		///<signature>
		///<summary>清空Cookie（默认域）</summary>
		///<param name="key" type="String">key</param>
		///</signature>
	},
	"SetBaseUrl":function(){
		///<signature>
		///<summary>设置BaseUrl</summary>
		///<param name="value" type="String">url</param>
		///</signature>
	},
	"GetBaseUrl":function(){
		///<signature>
		///<summary>获取BaseUrl</summary>
		///</signature>
	},
	...
	'ajax': function () {
		...
		/// </signature>
		/// <signature>
		///   <summary>Perform anHTTP (Ajax) request.</summary>
		///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup().</param>
		///   <returns type="jqXHR" />
		/// </signature>
	},
