...
{
    [MiicTable(MiicStorageName = "COMMUNITY_PUBLISH_INFO", Description = "圈子发布表")]
    public partial class PublishInfo
    {
        ...
        [MiicField(MiicStorageName = "PUBLISH_CONTENT", IsNotNull = true, MiicDbType = DbType.String, Description = "内容")]
