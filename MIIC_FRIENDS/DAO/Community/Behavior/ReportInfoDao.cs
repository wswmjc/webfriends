...
{
    public class ReportInfoDao : NoRelationCommon<ReportInfo>, ICommunityBehavior<ReportInfo>
    {
        ...
        /// <summary>
        /// 查询当前登录人员对指定行业圈子信息的举报信息
        /// </summary>
        /// <param name="communityBehaviorView">用户行为（举报）视图</param>
        /// <returns>举报信息</returns>
        public ReportInfo GetUserReportInfo(MyCommunityBehaviorView communityBehaviorView)
        {
            ...
            try
            {
                result = items.Find(o => o.PublishID == communityBehaviorView.PublishID && o.ReporterID == communityBehaviorView.LoginUserID);
                if (result == null)
                {
        ...
        /// <returns></returns>
        public bool IsReport(MyCommunityBehaviorView communityBehaviorView)
        {
            Contract.Requires<ArgumentNullException>(communityBehaviorView != null, "参数communityBehaviorView:不能为空");
            Contract.Requires<ArgumentNullException>(!string.IsNullOrEmpty(communityBehaviorView.PublishID), "参数communityBehaviorView.PublishID:不能为空");
            bool result = false;
        ...
        /// 受理举报
        /// </summary>
        /// <param name="publishID">被举报行业圈子信息ID</param>
